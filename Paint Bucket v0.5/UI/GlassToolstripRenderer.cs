    ...
    public class GlassToolstripRenderer : ToolStripSystemRenderer
    {
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            if (e.Item.Pressed || e.Item.Selected)
            {
                if (!e.Item.Enabled)
                {
                    backFillColorTop = GraphicsHelper.ToGray(backFillColorTop);
                    backFillColorBottom = GraphicsHelper.ToGray(backFillColorBottom);
                    insetOutlineColor = GraphicsHelper.ToGray(insetOutlineColor);
                    outlineColor = GraphicsHelper.ToGray(outlineColor);
                }
                else
                {
